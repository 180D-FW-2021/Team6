...
/*** START MOTORS ***/
const int motorIn1F = 27;
const int motorIn2F = 26;
...
void setup() {
  ...
  pinMode(motorIn1F, OUTPUT);
  pinMode(motorIn2F, OUTPUT);
...
void loop() {
  ...
  switch (gesture) {
    ...
    case 17:
      ...
      digitalWrite(motorIn1F, HIGH);
      digitalWrite(motorIn2F, LOW);
      delay(450);
      digitalWrite(motorIn2F, HIGH);
      myservo.write(180);
      delay(400);
      myservo.write(0);
      delay(150);      
